...
```gradle
dependencies {
    implementation 'com.github.zoom-us-community:jitpack-zoom-us:6.4.5.29521'
}
```
...
| :-----------: |:-----------------| :----------------------------------------------------------------------  |
| 6.4.5.29521 | exoplayer:2.17.1 | Removed commonlib.aar (has been merged into mobilertc.aar)               |
